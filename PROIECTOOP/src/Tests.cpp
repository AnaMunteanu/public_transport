...
void Tests::RunAllTests(){
    ...
    if(test_Ora()&&test_Statie()&&test_Matrix()&&test_Client()&&test_Card()
    		&&test_Bilet()&&test_Orar()&&test_Autobuz()&& test_Clientlogat()
			&& test_BazaDateClienti()&&test_BazaDateAutobuze()&&test_Ctrl()
			&&test_Nod()&&test_Harta()&& test_Filtre()&&test_Exception()
			&&test_dijkstra())
        cout<<"Tests ok!"<<endl;
}
