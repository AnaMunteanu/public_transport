...
void Harta::dijkstra(string start, string stop, vector<int>& dist, vector<string>& drum){
	/*Descr:functie care salveaza in vectorul drum statiile din traseul cel mai scurt dintre statia cu numele start si statia cu numele stop
	 * In:numele statiilor, vector de distante, vector de string(numele statiilor)
	 * Out:
	 */
